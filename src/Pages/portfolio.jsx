  ...
  return (
    <div className="about-container">
        ...
        <div className="card-container-grid">
            <Infocard title="Diet optimizer" content="For a school project, we built a website application where the user could input food items, and his desired daily nutrients. 
            ...
            <Infocard title="Minesweeper" content="For a school project, I made a minesweeper desktop application using Python. The application used Pyglet for UI and algorithms written by myself
            for the calculations of the game. I also made a statistic functionality that stores game data in a JSON file." />
            <Infocard title="Weather app" content="I made a weather forecasting website as a sideproject using React and various libraries. I learned a lot about using React, it's libraries
        ...
        <div className="card-container-grid">
            <Infocard title="Diet optimizer" image={stigler1}/>
            <Infocard title="Minesweeper" image={miinantallaaja1}/>
            <Infocard title="Weatherapp" image={weatherapp}/>  
        </div>
        <div className="card-container-grid">
            <Infocard title="Diet optimizer" image={stigler2}/>
            <Infocard title="Minesweeper" image={miinantallaaja2}/> 
        </div>
        </div>
        </div>
    </div>
